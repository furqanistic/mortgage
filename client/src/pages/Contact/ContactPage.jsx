      ...
      <main className='flex-grow'>
        ...
        <section className='relative pt-12 pb-16 sm:pt-20 sm:pb-24 overflow-hidden border-b border-border/50'>
          ...
          <div className='max-w-7xl mx-auto px-6 lg:px-8 relative z-10 text-center space-y-6'>
            ...
            >
              Initiate <span className='text-accent underline decoration-border/30 underline-offset-8'>Dialog</span>
            </motion.h1>
              ...
              <div className='grid gap-4'>
                 {[
                   ...
                   <motion.div 
                    ...
                    className='group flex items-center gap-5 p-5 bg-card border border-border rounded-3xl hover:border-accent/30 hover:shadow-lg hover:shadow-accent/5 transition-all duration-300'
                   >
                      <div className='w-12 h-12 rounded-2xl bg-secondary flex items-center justify-center text-muted-foreground group-hover:bg-accent group-hover:text-accent-foreground transition-colors'>
                        <item.icon size={20} />
                      </div>
                      <div>
                        <p className='text-[10px] font-black uppercase tracking-widest text-muted-foreground mb-1'>{item.title}</p>
                        <p className='text-lg font-bold text-foreground leading-none mb-1 group-hover:text-accent transition-colors'>{item.val}</p>
                 ...
                 <form onSubmit={handleSubmit} className='space-y-4 relative z-10'>
                    <div className='grid grid-cols-2 gap-4'>
                       <div className='space-y-1.5'>
                          ...
                          <input 
                            ...
                            className='w-full h-12 px-5 rounded-2xl bg-secondary border-none outline-none focus:ring-1 focus:ring-accent transition-all text-sm font-medium'
                          />
                       </div>
                       <div className='space-y-1.5'>
                    ...
                    <div className='space-y-1.5'>
                        ...
                        <textarea 
                          ...
                          rows={5}
                          className='w-full p-5 rounded-2xl bg-secondary border-none outline-none focus:ring-1 focus:ring-accent transition-all text-sm font-medium resize-none'
                        />
                    </div>

                    <Button className='w-full h-14 bg-primary text-primary-foreground rounded-2xl font-black text-xs uppercase tracking-widest shadow-xl shadow-primary/20 hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-2'>
                       Transmit Data
                       <Send size={14} />
                    </Button>
                 </form>
        ...
        <section className='bg-primary text-primary-foreground py-16 px-6 overflow-hidden'>
           <div className='max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-10'>
              <div className='space-y-4 max-w-lg text-center md:text-left'>
                 <h2 className='text-3xl font-heading font-black text-slate-50'>Visit Our <span className='text-blue-400'>HQ</span></h2>
